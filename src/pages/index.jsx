  ...
  <React.Fragment>
    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          <BigTitle>
            Hello, <br /> I'm Florin Dobre.
          </BigTitle>
          <Subtitle>I'm working on web and mobile apps used by over 1,000,000 people.</Subtitle>
        </Hero>
      </Content>
      {/*<DividerMiddle*/}
      ...
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            <ProjectCard
              title="fdobre.com"
              link="https://github.com/florindobre/fdobre-com"
              bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
            >
              This website's code is available on my Github page. Built with Gatsby, React, and other goodies.
            </ProjectCard>
          </ProjectsWrapper>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          <Title>About</Title>
          <AboutHero>
            <Avatar src={avatar} alt="Florin Dobre"/>
            <AboutSub>
              {/*todo: replace this with actual about*/}
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          ...
          <ContactText>
            Say <a href="mailto:plizNoSp4m@domain.tld">Hi</a> or find me on other <a
            href="https://github.com.com/florindobre">Github</a>.
          </ContactText>
        </Inner>
        <Footer>
          &copy; {new Date().getFullYear()} Florin Dobre.{' '}
          <a href="https://github.com/florindobre/fdobre-com">Github Repository</a>.
        </Footer>
      </Content>
